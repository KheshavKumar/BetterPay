                    ...
                    <Col md="auto" className='leftSideHOLDER'>
                        <div className='leftSideHolder'>
                            ...
                            <div className='smallCustHolder'>
                                ...
                                <div class="avatar">
                                    <Card border="light" className="text-white avatarImage" style={{ width: '15rem' }}>
                                        <Card.Img src={customerImage3} className="" alt="Card image">
                                        </Card.Img>
                                        <Card.ImgOverlay className='custImageOverlayHolder'>
                                    ...
                                    <div class="overlay">
                                    <Card border="light" className="text-white avatarImage" style={{ width: '15rem' }}>
                                        <Card.Img src={dogImage} className="" alt="Card image">
                                        </Card.Img>
                                        <Card.ImgOverlay className='custImageOverlayHolder'>
                                            <Card.Title className='custImageOverlayHolderTitle' >Cooper</Card.Title>
                                            <Card.Text className='custImageOverlayHolderSubTilte'>User from 2022</Card.Text>
                                        </Card.ImgOverlay>
                                    </Card>                                    </div>
                                </div>
